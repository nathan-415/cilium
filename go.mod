...
replace (
	...
	// Using cilium/netlink until neighboring patches merged upstream
	github.com/vishvananda/netlink => github.com/cilium/netlink v1.0.1-0.20211026134555-584b9786fb08
